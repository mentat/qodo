...
describe('awaitingApprovalTotal', () => {
  it('sums only invoices still awaiting approval', () => {
    const invoices: Invoice[] = [
      invoice({ id: '1', amount: 100_000, status: 'pending_approval' }),
      invoice({ id: '2', amount: 250_000, status: 'pending_approval' }),
      invoice({ id: '3', amount: 900_000, status: 'approved' }),
      invoice({ id: '4', amount: 500_000, status: 'paid' }),
      invoice({ id: '5', amount: 700_000, status: 'rejected' }),
    ];
